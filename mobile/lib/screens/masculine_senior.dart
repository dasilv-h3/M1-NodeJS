...
class SectionMasculineSeniorScreen extends StatefulWidget {
  const SectionMasculineSeniorScreen({super.key});

  @override
  _SectionMasculineSeniorScreenState createState() => _SectionMasculineSeniorScreenState();
}

class _SectionMasculineSeniorScreenState extends State<SectionMasculineSeniorScreen> {
 ...
 Future<List<Matches>> fetchData() async {
  final response = await http.get(Uri.parse('http://localhost:3000/api/matches/masculinsenior'));
