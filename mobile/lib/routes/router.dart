...
import 'package:fluterproject/widgets/new_details.dart';
    ...
    switch (settings.name) {
      ...
      case '/section_masculine_junior':
        return MaterialPageRoute(
          builder: (_) => SectionMasculineJuniorScreen(),
        );
      case '/section_masculine_senior':
        return MaterialPageRoute(
          builder: (_) => SectionMasculineSeniorScreen(),
        );
      ...
      case '/add_news':
        return MaterialPageRoute(
          builder:
              (_) => AjoutActualitiesScreen(
                onNewsAdded: (title, description) {
      ...
      case '/user_preferences': // Route pour la page des préférences utilisateur
        return MaterialPageRoute(
          builder: (_) => Favoris(),
        ); // Page Favoris avec la logique de préférences
      case '/contact': // Nouvelle route pour la page de contact
        return MaterialPageRoute(
          builder: (_) => ContactScreen(),
        ); // Ajout de la page ContactScreen
      default:
        return MaterialPageRoute(
